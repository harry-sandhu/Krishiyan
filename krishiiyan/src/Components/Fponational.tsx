...
function Fponational() {
  ...
  return (
    <>
      ...
      <Navbar />
      <section
        className="bg-cover bg-center h-[300px] sm:h-[400px] lg:h-[500px] relative"
      ...
      <div className="xl:m-20 sm:mt-5">
        ...
        <h5 className="text-5xl m-2">
          Welcome to the FPO National Conference in Patna by Sahakar Bharati
        </h5>
        <div className="bg-white p-5 rounded-lg shadow-md">
          <h3 className="text-xl font-bold mb-3">Sahakar Bharati</h3>
          <p className="text-justify">
            Sahakar Bharati is a non-governmental organization committed to
            promoting the cooperative movement and empowering rural communities
            across India. With a focus on agriculture and allied sectors, we
            strive to foster sustainable development and inclusive growth
            through cooperative principles and practices.
          </p>
        </div>
          ...
          <div className="w-full sm:w-1/2 bg-blue-gray-50 rounded-xl p-2">
            ...
            <p className="text-justify p-2">
              <span className="">
                ...
                stakeholders, experts, and policymakers to explore innovative
                solutions, share best practices, and foster collaboration in the
                agricultural sector.
              </span>
            </p>
          </div>
          <div className="w-full sm:w-1/2 bg-blue-gray-50 rounded-xl p-2">
            <h3 className="text-left text-3xl mx-1">Our Objectives:</h3>
            <p className="text-justify p-2">
              <span className="">
                ...
                initiatives to support the growth of FPOs. Explore avenues for
                technology adoption and market linkages for FPOs. Empower
                farmers through capacity building workshops and training
                sessions.
              </span>
            </p>
          </div>
        ...
        <div
          ...
          style={{ backgroundImage: `url(${fpowheat})` }}
        >
          ...
          <div className="bg-gray-400/50 rounded-xl">
            <ul className="text-justify list-disc pl-10 p-5">
              ...
              <li>
                Learn from industry experts and thought leaders through
                interactive sessions and panel discussions.
              </li>
              <li>
                Discover opportunities for collaboration, investment, and
                partnership in the FPO ecosystem.
              </li>
              <li>
                Be a part of the collective effort to empower farmers and build
      ...
      <div className="flex flex-col md:flex-row xl:ml-5">
        ...
        <div className="w-full md:w-1/2 mt-4 md:mt-0 xl:mt-10 sm:order-2">
          ...
          <ul className="list-disc p-5 text-justify xl:leading-10 text-xl mx-28">
            <li className="">
      ...
      <div className="bg-gray-200 mt-[20px] p-5 rounded-lg shadow-md">
        <h3 className="text-2xl font-bold mb-3">Registration</h3>
        <p className="text-center pb-5 text-lg">
          Secure your spot at the FPO National Conference in Patna by
          registering online.
        </p>
        <Button
      ...
      <div className="bg-blue-gray-50 p-10 rounded-lg mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="bg-white p-5 rounded-lg shadow-md">
            ...
            <p className="text-justify">
              Stay updated on the latest news and announcements about the FPO
              Conference by following us on social media. Join the conversation
              using #FPOConferencePatna and be a part of the dialogue shaping
