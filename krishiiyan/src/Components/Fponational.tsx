    ...
    return (
        <>
            ...
            <div className='xl:m-20 sm:mt-5'>
                ...
                <h5 className='text-5xl m-2'>Welcome to the FPO National Conference in Patna by Sahakar Bharati</h5>
            ...
            <div className='flex flex-col md:flex-row xl:ml-5'>
                ...
                <div className='w-full md:w-1/2 mt-4 md:mt-0 xl:mt-10 sm:order-2'>
                    ...
                    <ul className='list-disc p-5 text-justify xl:leading-10 text-xl mx-28'>
                        <li className=''>Farmers and Farmer Producer Organizations (FPOs)</li>
            ...
            <div className="bg-gray-200 mt-[20px] p-5 rounded-lg shadow-md">
                ...
                <p className="text-center pb-5 text-lg">
                    Secure your spot at the FPO National Conference in Patna by registering online.
                </p>
                <Button style={{ backgroundColor: "rgb(132 204 22)", color: "white" }} onClick={handleregisterclick}>Click to Register</Button>
            </div>
            ...
            <div className="bg-blue-gray-50 p-10 rounded-lg mt-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="bg-white p-5 rounded-lg shadow-md">
                        ...
                        <p className="text-justify">
                            For inquiries and assistance regarding the conference, feel free to reach out to us at <a href="tel:+91 7066744494" className="hover:underline font-bold">
                                +917066744494
                            </a> / <a
