...
function What0() {
    ...
    return (
        <section className='cardsection'>
            <div>
                <h1 className='text-center text-black text-4xl font-bold pt-10'>Our Services</h1>
                <p className='text-center text-black text-xl p-10'>Krishiyan offers a range of services designed to meet the diverse needs of farmers, Farmer Producers Organisation, industries, and other stakeholders across the agricultural supply chain</p>
            </div>
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {cardData.map((card, idx) => (
                    <div key={idx} className="ourservice_card card bg-white shadow-lg rounded p-4 w-full flex flex-col justify-between mb-20">
                        {/* Icon image */}
                        <img src={card.icon} alt={`Icon ${idx + 1}`} className="mb-4 mx-auto rounded-lg imgbx" />
