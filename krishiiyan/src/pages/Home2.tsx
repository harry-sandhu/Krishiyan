...
function Home2() {
    ...
    return (
        <section id='about' className='pt-24'>
            <motion.div
                style={bgStyle}
                className='md:p-20 flex flex-col justify-center items-center xl:mt-2 h-[50vh]'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
                ...
                <motion.div
                    className="bg-[#3DB73E] opacity-90 rounded-xl p-4 md:p-10 h-auto"
                    initial={{ scale: 0.9 }}
                    animate={{ scale: 1 }}
                    transition={{ duration: 0.5 }}
                >
                    <h1 className='text-2xl md:text-4xl pb-2'>About Us</h1>
                    <p className='text-lg md:text-[22px] xl:leading-9 text-opacity-100'>
